...
export const winLevelMap = {
	...
	2: {
		...
		sound: { sfx: 'sfx_winlevel_standard' as const, bgm: undefined },
		animation: undefined,
	},
	3: {
		level: 3,
		...
		sound: { sfx: 'sfx_winlevel_small' as const, bgm: undefined },
		animation: undefined,
	},
	4: {
		level: 4,
		...
		sound: { sfx: 'sfx_winlevel_nice' as const, bgm: undefined },
		animation: undefined,
	},
	5: {
		level: 5,
		...
		sound: { sfx: 'sfx_winlevel_substantial' as const, bgm: undefined },
		animation: undefined,
	},
	6: {
		level: 6,
		...
		sound: { sfx: 'sfx_winlevel_big' as const, bgm: 'bgm_winlevel_big' as const },
	...
	7: {
		...
		sound: { sfx: 'sfx_winlevel_superwin' as const, bgm: 'bgm_winlevel_superwin' as const },
	...
	8: {
		...
		sound: { sfx: 'sfx_winlevel_mega' as const, bgm: 'bgm_winlevel_mega' as const },
	...
	9: {
		...
		sound: { sfx: 'sfx_winlevel_epic' as const, bgm: 'bgm_winlevel_epic' as const },
	...
	10: {
		...
		sound: { sfx: 'sfx_winlevel_max' as const, bgm: 'bgm_winlevel_max' as const },
