...
export const defaultTheme: CoreTheme = {
	...
	typography: {
		microLabel: { fontFamily: 'proxima-nova', fontSize: 45, fontWeight: '400', letterSpacing: 0, fill: '#FFFFFF' },
		primaryValue: { fontFamily: 'proxima-nova', fontSize: 45, fontWeight: '400', letterSpacing: 0, fill: '#FFFFFF' },
		betValue: { fontFamily: 'proxima-nova', fontSize: 45, fontWeight: '400', letterSpacing: 0, fill: '#FFFFFF' },
		winZero: { fontFamily: 'proxima-nova', fontSize: 45, fontWeight: '400', letterSpacing: 0, fill: '#FFFFFF' },
		winActive: { fontFamily: 'proxima-nova', fontSize: 45, fontWeight: '400', letterSpacing: 0, fill: '#FFFFFF' },
		winBig: { fontFamily: 'proxima-nova', fontSize: 45, fontWeight: '400', letterSpacing: 0, fill: '#FFFFFF' },
	},
	motion: {
